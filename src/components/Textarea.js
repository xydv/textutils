  ...
  return (
    <>
      <div className="mb-3">
        ...
        <button className="btn btn-primary mx-1 my-2 btn-sm" onClick={upclicked} >Uppercase</button>
        <button className="btn btn-primary mx-1 my-2 btn-sm" onClick={lowclicked} >Lowercase</button>
        <button className="btn btn-primary mx-1 my-2 btn-sm" onClick={cleartext} >Clear</button>
        <button className="btn btn-primary mx-1 my-2 btn-sm" onClick={copyclip} >Copy Text</button>
      </div>
      <div className="container">
        ...
        <p className={`my-3 text-${props.mode === "light" ? "dark" : "light"}`}>Words :- <span className="badge bg-secondary">{text.split(" ").length}</span></p>
	  ...
	  <div className="container">
	  <h2 className={`my-4 text-${props.mode === "light" ? "dark" : "light"}`}>Turn Into Voice!<span class="badge bg-info mx-3">New</span></h2>
	  <audio 
